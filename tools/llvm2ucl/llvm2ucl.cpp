...
static llvm::cl::opt<std::string>
    OutputFilename("ucl", llvm::cl::desc("Output UCLID5 filename"),
...
int main(int argc, char **argv) {
  ...
  llvm::cl::ParseCommandLineOptions(
      argc, argv, "llvm2ucl - LLVM bitcode to UCLID5 transformation\n");
  ...
  if (!OutputFilename.empty()) {
    ...
    pass_manager.add(new smack::UclFilePrinter(F->os()));
  }
